...
class BlackKing(BlackPiece):
	...
	def calculate_moves(self):
		...
		potential_moves = potential_moves & ~board.king_move_bitboards[pieces[1<<30].eightx_y]
	...
	def find_pins(self):
		...
		for pinner_piece in board.white_pinners:
			if pinner_piece & board.active_white_pieces > 0:
				pinned_pieces.append(self.find_pin_by_piece(pinner_piece, board.all_black_positions, board.all_white_positions))
